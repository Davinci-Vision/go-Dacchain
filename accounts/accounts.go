...
// Package accounts implements high level Dacchain account management.
package accounts

import (
	"math/big"

	Dacchain "github.com/Dacchain/go-Dacchain"
	"github.com/Dacchain/go-Dacchain/common"
	"github.com/Dacchain/go-Dacchain/core/types"
	"github.com/Dacchain/go-Dacchain/event"
)

// Account represents an Dacchain account located at a specific location defined
// by the optional URL field.
type Account struct {
	Address common.Address `json:"address"` // Dacchain account address derived from the key
