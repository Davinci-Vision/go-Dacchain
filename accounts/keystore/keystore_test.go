...
func TestKeyStore_Import(t *testing.T) {
	// keyStore := NewKeyStore("/Users/yujian/Library/Dacchain/keystore", veryLightScryptN, veryLightScryptP)
	...
	key, err := keyStore.storage.GetKey(address, "/Users/yujian/Library/Dacchain/keystore/UTC--2018-03-07T05-43-28.637655000Z--34f6feaa439ea2e92438365933067acaff5e3b7c", "yujian")
	if err != nil {
...
func TestGetPrivateKeyByKeyFile(t *testing.T) {
	...
	password := "yujian"
	fileName := "/Users/yujian/Library/Dacchain/keystore/UTC--2018-03-07T05-43-28.637655000Z--34f6feaa439ea2e92438365933067acaff5e3b7c"
...
func tmpKeyStore(t *testing.T, encrypted bool) (string, *KeyStore) {
	d, err := ioutil.TempDir("", "dac-keystore-test")
	if err != nil {
		t.Fatal(err)
	}
