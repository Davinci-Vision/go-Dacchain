...
func makeTestState() (Database, *dacdb.MemDatabase, common.Hash, []*testAccount) {
	// Create an empty state
	mem, _ := dacdb.NewMemDatabase()
	db := NewDatabase(mem)
...
// account array.
func checkStateAccounts(t *testing.T, db dacdb.Database, root common.Hash, accounts []*testAccount) {
...
func checkTrieConsistency(db dacdb.Database, root common.Hash) error {
...
func checkStateConsistency(db dacdb.Database, root common.Hash) error {
