...
// Package state provides a caching layer atop the Dacchain state trie.
package state
...
// StateDBs within the davinci protocol are used to store anything
...
//
// Carrying over the balance ensures that dac doesn't disappear.
