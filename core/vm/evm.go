...
type Context struct {
	...
	// sufficient dac to transfer the value
	CanTransfer CanTransferFunc
	// Transfer transfers dac from one account to the other
...
// EVM is the Davinci Virtual Machine base object and provides
...
type EVM struct {
	...
	// evm.
	vmConfig Config
	// global (to this context) Davinci virtual machine
