...
// Contract represents an davinci contract in the state database. It contains
...
// Asset returns the contracts asset (sent to it from it's caller), if nil it means dac
