...
// Package walletType contains data walletType related to Davinci consensus.
package types
...
// Header represents a block header in the Davinci blockchain.
type Header struct {
...
// Block represents an entire block in the Davinci blockchain.
type Block struct {
	header       *Header
	...
	// These fields are used by package dac to track
...
// [deprecated by dac/63]
// StorageBlock defines the RLP encoding of a Block stored in the
// state database. The StorageBlock encoding contains fields that
// would otherwise need to be recomputed.
type StorageBlock Block

// "external" block encoding. used for dac protocol, etc.
...
// EncodeRLP serializes b into the Davinci RLP block format.
