...
// Package core implements the Davinci consensus protocol.
package core
...
import (
	...
	"github.com/Dacchain/go-Dacchain/core/watch"
)
...
// available in the database. It initialises the default Davinci Validator and
// Processor.
func NewBlockChain(chainDb dacdb.Database, config *params.ChainConfig, dacEngine consensus.Engine, vmConfig vm.Config, itxDb dacdb.Database) (*BlockChain, error) {
...
func (bc *BlockChain) InsertReceiptChain(blockChain types.Blocks, receiptChain []types.Receipts) (int, error) {
	...
	for i, block := range blockChain {
		...
		if batch.ValueSize() >= dacdb.IdealBatchSize {
