...
func TestDefaultGenesisBlock(t *testing.T) {
	file, _ := os.Open("/Users/dac/workspace/go-workspace/github-workspace/src/github.com/Dacchain/go-Dacchain/genesis.json")
	data, _ := ioutil.ReadFile("/Users/dac/workspace/go-workspace/github-workspace/src/github.com/Dacchain/go-Dacchain/genesis.json")
...
func TestSetupGenesis(t *testing.T) {
	...
	tests := []struct {
		name       string
		fn         func(dacdb.Database) (*params.ChainConfig, common.Hash, *Genesis, error)
	...
	}{
		{
			...
			fn: func(db dacdb.Database) (*params.ChainConfig, common.Hash, *Genesis, error) {
