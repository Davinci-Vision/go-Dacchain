...
func makeHeaderChain(parent *types.Header, n int, db dacdb.Database, seed int) []*types.Header {
...
// header only chain.
func newCanonical(n int) (dacdb.Database, *LightChain, error) {
...
func (odr *dummyOdr) Database() dacdb.Database {
	return odr.db
}
