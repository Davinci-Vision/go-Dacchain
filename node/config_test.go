...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "dac.ipc", false, filepath.Join(os.TempDir(), "dac.ipc")},
		{"data", "dac.ipc", false, "data/dac.ipc"},
		{"data", "./dac.ipc", false, "./dac.ipc"},
		{"data", "/dac.ipc", false, "/dac.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "dac.ipc", true, `\\.\pipe\geth.ipc`},
		{"data", "dac.ipc", true, `\\.\pipe\geth.ipc`},
