...
import (
	...
	"github.com/Dacchain/go-Dacchain/accounts/keystore"
...
type Config struct {
	...
	// used in the devp2p node identifier. The instance name of dac is "dac". If no
...
// These resources are resolved differently for "dac" instances.
...
func (c *Config) resolvePath(path string) string {
	...
	// by dac 1.4 are used if they exist.
	if c.name() == "dac" && isOldGethResource[path] {
		oldpath := ""
		if c.Name == "dac" {
