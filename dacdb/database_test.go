...
func newTestLDB() (*dacdb.LDBDatabase, func()) {
	dirname, err := ioutil.TempDir(os.TempDir(), "dacdb_test_")
	if err != nil {
		panic("failed to create test file: " + err.Error())
	}
	db, err := dacdb.NewLDBDatabase(dirname, 0, 0)
	if err != nil {
...
func testPutGet(db dacdb.Database, t *testing.T) {
	t.Parallel()
...
func testParallelPutGet(db dacdb.Database, t *testing.T) {
	const n = 8
