...
// Package p2p implements the Dacchain p2p network protocols.
package p2p
...
import (
	...
	"github.com/Dacchain/go-Dacchain/p2p/nat"
	"github.com/Dacchain/go-Dacchain/p2p/netutil"
)
	...
	if !srv.NoDiscovery {
		...
		if srv.NAT != nil {
			if !realaddr.IP.IsLoopback() {
				go nat.Map(srv.NAT, srv.quit, "udp", realaddr.Port, realaddr.Port, "davinci discovery")
			}
...
func (srv *Server) startListening() error {
	...
	if !laddr.IP.IsLoopback() && srv.NAT != nil {
		srv.loopWG.Add(1)
		go func() {
			nat.Map(srv.NAT, srv.quit, "tcp", laddr.Port, laddr.Port, "davinci p2p")
			srv.loopWG.Done()
		}()
	}
	return nil
