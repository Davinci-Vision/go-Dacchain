...
import (
	...
	"runtime"
	"github.com/Dacchain/go-Dacchain/rpc"
...
type DavinciDpos struct {
	// config Config
	lock sync.Mutex
}

func New() *DavinciDpos {
	return &DavinciDpos{}
}
...
func (d *DavinciDpos) Prepare(chain consensus.ChainReader, header *types.Header) error {
...
func (d *DavinciDpos) Finalize(chain consensus.ChainReader, header *types.Header, state *state.StateDB, dState *delegatestate.DelegateDB, txs []*types.Transaction, receipts []*types.Receipt) (*types.Block, error) {
...
func (d *DavinciDpos) VerifyHeaderAndSign(chain consensus.ChainReader, block *types.Block, currentShuffleList *types.ShuffleList,blockInterval int) error {
	header := block.Header()
	parent := chain.GetHeader(header.ParentHash, header.Number.Uint64()-1)
...
func (d *DavinciDpos) VerifySignatureSend(blockHash common.Hash, confirmSign []byte, currentShuffleList *types.ShuffleList) error {
...
func (d *DavinciDpos) VerifyBlockGenerate(chain consensus.ChainReader, block *types.Block, currentShuffleList *types.ShuffleList,blockInterval int) error {
...
func (d *DavinciDpos) VerifyHeaders(chain consensus.ChainReader, headers []*types.Header) (chan<- struct{}, <-chan error) {
...
func (d *DavinciDpos) verifyHeaders(chain consensus.ChainReader, headers []*types.Header, index int) error {
...
func (d *DavinciDpos) verifyHeader(chain consensus.ChainReader, header, parent *types.Header) error {
...
func (d *DavinciDpos) VerifyHeader(chain consensus.ChainReader, header *types.Header) error {
...
// that is empty.
func (d *DavinciDpos) APIs(chain consensus.ChainReader) []rpc.API {
	return nil
}

func (d *DavinciDpos) Author(header *types.Header) (common.Address, error) {
